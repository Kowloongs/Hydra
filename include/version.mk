...
VERSION_NUMBER:=$(if $(VERSION_NUMBER),$(VERSION_NUMBER),1.0.1-VERSIFY)
...
VERSION_DIST:=$(if $(VERSION_DIST),$(VERSION_DIST),Hydra)
VERSION_DIST_SANITIZED:=$(call sanitize,$(VERSION_DIST))

VERSION_MANUFACTURER:=$(call qstrip,$(CONFIG_VERSION_MANUFACTURER))
VERSION_MANUFACTURER:=$(if $(VERSION_MANUFACTURER),$(VERSION_MANUFACTURER),Ombres)
